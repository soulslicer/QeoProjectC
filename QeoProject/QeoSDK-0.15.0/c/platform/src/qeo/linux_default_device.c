...
#define LINUX_UUID_GENERATOR "/proc/sys/kernel/random/uuid"     /*The path of the UUID generator used in the proc filesystem*/
...
const qeo_platform_device_info *get_default_device_info(void)
{
    ...
    _default_device_info.qeoDeviceId = qeo_get_device_uuid(path, LINUX_UUID_GENERATOR);
